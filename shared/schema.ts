...
// Trading Academy (PR F) was replaced by Missions — tables dropped in
// migration 0026_drop_trading_academy.sql. See server/storage.ts and
// server/modules/search.ts history for the removed CRUD/search code.
