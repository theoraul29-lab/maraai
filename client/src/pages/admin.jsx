                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {order.orderType && (
                              <span
                                className={`text-xs px-1.5 py-0.5 rounded ${order.orderType === "trading" ? "bg-cyan-500/20 text-cyan-400" : "bg-yellow-500/20 text-yellow-400"}`}
                              >
                                {order.orderType}
                                {order.subscriptionPeriod &&
                                order.subscriptionPeriod !== "once"
                                  ? ` (${order.subscriptionPeriod})`
                                  : ""}
                              </span>
                            )}
