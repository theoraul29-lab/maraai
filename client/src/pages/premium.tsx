...
function PayPalButton({ onSuccess }: { onSuccess: () => void }) {
  ...
  useEffect(() => {
    if (!loading && !error && (window as any).paypal) {
      renderButton();
    }
...
export default function PremiumPage() {
  ...
  const { data: status } = useQuery<PremiumStatus>({
  ...
  const features = [
    { icon: MessageCircle, key: "premium.feature.unlimitedChat" as const },
    { icon: Mic, key: "premium.feature.voiceAi" as const },
    { icon: Sparkles, key: "premium.feature.prioritySupport" as const },
    { icon: Palette, key: "premium.feature.exclusiveThemes" as const },
    { icon: Brain, key: "premium.feature.advancedAnalysis" as const },
    { icon: Ban, key: "premium.feature.noAds" as const },
  ];
