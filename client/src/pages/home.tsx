...
function MaraOutput({ onOpenChat }: { onOpenChat: () => void }) {
              ...
              >
                {MARA_VOICES.map((v) => (
                  <button
                    ...
                    className={`w-full text-left px-2.5 py-1.5 rounded-lg text-[10px] transition flex items-center gap-1.5 ${
...
export default function Home() {
  const [activeView, setActiveView] = useState<"hub" | "reels" | "chat">("hub");
