...
export function FeedbackWidget() {
  ...
  const submitMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: t("feedback.success" as any) });
      setMessage("");
      setCategory("general");
      setOpen(false);
    },
    onError: () => {
      toast({ title: t("feedback.error" as any), variant: "destructive" });
    },
  });
      ...
      {open && (
        ...
        >
          ...
          <Textarea
            ...
            placeholder={t("feedback.placeholder" as any)}
          ...
          >
            ...
            {submitMutation.isPending ? "..." : t("feedback.submit" as any)}
          </Button>
        </div>
      )}
    </div>
