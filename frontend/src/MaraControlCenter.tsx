...
export default function MaraControlCenter() {
  ...
  // view's own content region does. Scoped to this component's lifetime.
  useEffect(() => {
  ...
  const navItem = (label: string, view: View, key?: string) => (
    <button key={key ?? label} type="button" className={`mcc-sidebar-item ${activeView === view ? 'mcc-sidebar-item--active' : ''}`} onClick={() => setActiveView(view)}>
      <span><i className="mcc-nav-icon" />{label}</span>
    </button>
  );
  ...
  return (
    <main className="mcc-shell mcc-shell--desktop">
      <aside className="mcc-sidebar" aria-label="Mara Control Center navigation">
        ...
        <div className="mcc-sidebar-group" style={{ borderTop: 'none', marginTop: 0, paddingTop: 0 }}>
        ...
        <div className="mcc-sidebar-group">
          <div className="mcc-sidebar-title">HELLOMARA.NET</div>
          {modules.map((module) => <button key={module.id} type="button" className={`mcc-sidebar-item ${activeView === 'modules' && selectedModule?.id === module.id ? 'mcc-sidebar-item--active' : ''}`} onClick={() => { setSelectedModuleId(module.id); setActiveView('modules'); }}><span>{module.icon} {module.displayName}</span><i className={healthDotClass(module.healthStatus.overall)} /></button>)}
        </div>
        <div className="mcc-sidebar-group">
          <div className="mcc-sidebar-title">Development</div>
          {navItem('Repository', 'repository')}
          {navItem('Code Explorer', 'repository', 'code-explorer')}
          {navItem('Git', 'repository', 'git')}
        </div>
        <div className="mcc-sidebar-group">
          <div className="mcc-sidebar-title">Infrastructure</div>
          {navItem('GitHub', 'github')}
          {navItem('Railway', 'railway')}
        </div>
        <div className="mcc-sidebar-group">
          <div className="mcc-sidebar-title">Operations</div>
          {navItem('Tasks', 'tasks')}
      ...
      <div className="mcc-main-workspace">
        ...
        {activeView === 'modules' && <div className="mcc-view">
          ...
          {selectedModule && <section className="mcc-panel mcc-panel--wide mcc-panel--scroll mcc-module-workspace">
        ...
        {activeView === 'agents' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide">
        ...
        {activeView === 'repository' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide mcc-panel--scroll">
        ...
        {activeView === 'tasks' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide mcc-panel--scroll">
        ...
        {activeView === 'audit' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide mcc-panel--scroll">
        ...
        {activeView === 'security' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide mcc-panel--scroll">
        ...
        {activeView === 'integrations' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide mcc-panel--scroll">
        ...
        {activeView === 'github' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide mcc-panel--scroll">
        ...
        {activeView === 'railway' && <div className="mcc-view">
          <section className="mcc-panel mcc-panel--wide mcc-panel--scroll">
        ...
        {activeView === 'telemetry' && <div className="mcc-view">
