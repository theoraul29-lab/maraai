...
const MODULE_DEFINITIONS: readonly ModuleDefinition[] = [
  {
    ...
    databaseDependencies: ['missions', 'user_missions', 'mission_events', 'mission_shares', 'mission_programs', 'user_program_enrollments', 'mission_proofs', 'mission_generation_queue', 'mission_feedback', 'user_personality', 'user_preferences'],
    apiEndpoints: ['/api/missions', '/api/missions/daily', '/api/missions/suggest', '/api/missions/generate', '/api/missions/:id/start', '/api/missions/:id/proof', '/api/missions/share', '/api/missions/:userMissionId/share-as-spark', '/api/missions/community', '/api/missions/stats', '/api/missions/feedback', '/api/programs', '/api/programs/:slug', '/api/programs/:slug/enroll'],
