...
const MODULE_DEFINITIONS: readonly ModuleDefinition[] = [
  ...
  },
  {
    ...
    backendFiles: ['server/billing/api.ts', 'server/billing/features.ts', 'server/billing/plans.ts', 'server/billing/seed.ts', 'server/billing/stripe.ts', 'server/billing/paypal.ts', 'server/modules/orders.ts', 'server/modules/payments.ts', 'server/modules/adminOrders.ts'],
    databaseDependencies: ['plans', 'subscriptions', 'premium_orders', 'users'],
    apiEndpoints: ['/api/premium/status', '/api/premium/order', '/api/billing/paypal/status', '/api/billing/plans', '/api/billing/me', '/api/billing/subscribe', '/api/billing/cancel', '/api/billing/stripe/webhook', '/api/billing/paypal/webhook'],
