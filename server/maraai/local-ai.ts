...
export function tryLocalAI(message: string, language?: string | null): LocalAIResult | null {
  ...
  if (HELP.some((r) => r.test(m))) {
    return {
      response: localized(lang, {
        en: 'I can chat, generate ideas, guide you through Missions and growth programs, and curate Sparks. In Hybrid or Advanced mode I can also share the load with peer nodes — see the Transparency dashboard for full details.',
        ro: 'Pot vorbi, genera idei, te ghida prin Misiuni și programe de creștere, și curata Sparks. În modul Hybrid sau Advanced pot împărți efortul cu nodurile peer — vezi panoul Transparency pentru detalii complete.',
        es: 'Puedo conversar, generar ideas, guiarte por Misiones y programas de crecimiento, y curar Sparks. En modo Hybrid o Advanced también reparto la carga con nodos peer — ve el panel de Transparency para los detalles.',
        fr: 'Je peux discuter, générer des idées, vous guider à travers Missions et programmes de croissance, et organiser les Sparks. En mode Hybrid ou Advanced je partage aussi la charge avec les nœuds peer — vois le tableau Transparency pour les détails.',
      }),
      confidence: 0.8,
